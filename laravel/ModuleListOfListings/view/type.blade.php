<div class="row">
    <div class="col-md-6">
        <div class="form-group">
            ...
            <input class="form-control" type="text" name="fielddata[][][count]"
    ...
    <div class="col-md-6">
        <div class="form-group">
            ...
            <select class="form-control" name="fielddata[][][listingType]">
...
<div class="form-group">
    ...
    <select class="form-control" name="fielddata[][][rel]">
...
<div class="row">
    <div class="col-md-6">
        <div class="form-group">
            ...
            <select class="form-control criteriaMostPopular" name="fielddata[][][criteria]">
    ...
    <div class="col-md-6">
        <div class="form-group timeDuration" @if($settings['criteria']!='comments') style="display: none" @endif>
            ...
            <select class="form-control" name="fielddata[][][timeDuration]">
